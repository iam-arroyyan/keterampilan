            ...
            <?php $result = mysqli_query($conn, "SELECT * FROM menu ORDER BY id ASC"); ?>
                ...
                <div class="col 10 mx-auto my-3 col-md-6 col-lg-4">
                  <div class="card car-card">
                     ...
                     <img src="../images/<?= $data["gambar"]; ?>" class="card-img-top car-img" alt="car">

                     <div class="card-body">
                        <div class="car-info d-flex justify-content-between">

                           <div class="car-text text-uppercase">
                              <h6 class="font-weight-bold"><?= $data["merk"]; ?></h6>
                              <h6><?= $data["nama"]; ?></h6>
                           </div>

                           <h5 class="car-value align-self-center py-2 px-3">Rp
                              <span class="car-price"><?= $data["harga"]; ?></span>
                           </h5>
                     ...
                     <div class="card-footer text-capitalize d-flex justify-content-between">
                        <p><span><i class="fas fa-motorcycle"></i></span><?= $data["jenis"]; ?></p>
                        <p><span><i class="fas fa-history"></i></span><?= $data["jarak"]; ?></p>
                        <p><span><i class="fas fa-calendar-alt	"></i></span><?= $data["tahun"]; ?></p>
                        <p><span><i class="fa fa-paint-brush"></i></span><?= $data["warna"]; ?></p>
                     </div>
